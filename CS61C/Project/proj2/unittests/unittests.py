...
class TestRelu(TestCase):
    ...
    def test_size_zero(self):
        ...
        # call the relu function
        t.call("relu")
        # generate the `assembly/TestRelu_test_zero.s` file and run it through venus
        t.execute(78)
...
class TestArgmax(TestCase):
    ...
    def test_size_one(self):
        ...
        # check that the register a0 contains the correct output
        t.check_scalar("a0", 0)
        # generate the `assembly/TestArgmax_test_size_one.s` file and run it through venus
        t.execute()
    ...
    def test_all_equal(self):
        ...
        # check that the register a0 contains the correct output
        t.check_scalar("a0", 0)
        # generate the `assembly/TestArgmax_test_all_equal.s` file and run it through venus
        t.execute()
    ...
    def test_empty_array(self):
        ...
        # call the argmax function
        t.call("argmax")
        # generate the `assembly/TestRelu_test_empty_array.s` file and run it through venus
        t.execute(77)
...
class TestDot(TestCase):
    def test_simple(self):
        ...
        # load array addresses into argument register
        t.input_array("a0", array0)
    ...
    def test_stride_zero(self):
        t = AssemblyTest(self, "dot.s")
        # create arrays in the data section
        array0 = t.array([1, 2, 4])
        array1 = t.array([1, 2, 4])
        # load array addresses into argument register
        t.input_array("a0", array0)
        t.input_array("a1", array1)
        # load array attributes into argument registers
...
class TestMatmul(TestCase):
    ...
    def test_error_case_unmatch(self):
        self.do_matmul(
            [1, 2, 3, 4, 5, 6, 7, 8, 9],
            3,
            3,
    ...
    def test_error_case_zero_size_first(self):
        self.do_matmul(
            [1, 2, 3, 4, 5, 6, 7, 8, 9],
            0,
            3,
    ...
    def test_error_case_zero_size_second(self):
        self.do_matmul(
            [1, 2, 3, 4, 5, 6, 7, 8, 9],
            3,
            3,
